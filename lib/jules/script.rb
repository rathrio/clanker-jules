...
module Jules
  module Script
    ...
    STAKEOUT_ENTRANCE_LINES = [
      ...
      proc { |pm| "Jules pockets the keys. From here on, eyes only.\n#{pm} on the wire." },
      proc { |pm| "The toolkit goes back in the trunk. Stakeout begins.\n#{pm}, hands in the pockets." },
      proc { |pm| "Jules holsters the bash. Holsters the edit. Holsters the write.\n#{pm} settles in to watch." },
      proc { |pm| "A long breath. The hands come off the keys.\n#{pm}. Observation only." },
      proc { |pm| "Jules pulls the brim down. No contact. No edits.\n#{pm}. Just the wire." },
      proc { |pm| "The shell goes cold. Jules switches to look-and-listen.\n#{pm}. No triggers, just eyes." },
      proc { |pm| "Stakeout. Jules trades the toolbelt for a notebook.\n#{pm} along for the ride." },
      proc { |pm| "Jules puts the gloves on the dash. Tonight is hands-off.\n#{pm}. Eyes only." },
      proc { |pm| "Jules cuts the engine. Kills the lights. Switches to listen-only.\n#{pm} in the dark." },
      proc { |pm| "The toolbelt comes off. The notebook comes out. Stakeout.\n#{pm}. Fresh page, sharp pencil." },
      proc { |pm| "Jules locks the keyboard in the glovebox.\n#{pm}. Eyes on the wire from here on out." },
      proc { |pm| "Jules leans the chair back, hands behind the head.\n#{pm}. No more moves. Just watching." },
      proc { |pm| "A long, slow breath. Jules sets the tools aside.\n#{pm}. Tonight is observation only." },
      proc { |pm| "Jules taps the brakes on the impulse to act.\n#{pm} coasts the rest of the way in." },
      proc { |pm| "The hammer goes back in the drawer. Jules picks up the magnifying glass.\n#{pm} behind the lens." },
      proc { |pm| "Jules signals the dispatcher: hold position.\n#{pm}. No contact until further notice." },
      proc { |pm| "The fingers come off the trigger. The eyes stay on the door.\n#{pm}. No more moves." },
      proc { |pm| "Jules pulls the brim low. From here it's all watch and wait.\n#{pm} along for the quiet." },
      proc { |pm| "The shop closes. The watch begins.\n#{pm}. Arms folded, eyes open." },
      proc { |pm| "Jules switches the radio to receive-only. The mic stays cold.\n#{pm}. Listening only." },
      proc { |pm| "Tools off. Eyes on.\n#{pm}. The reel rolls without anyone touching the projector." },
      proc { |pm| "Jules puts the pen down. Picks up the binoculars.\n#{pm}. Magnification mode." },
      proc { |pm| "A nod to nobody. Jules slips into stakeout posture and stays there.\n#{pm} on standby." },
      proc { |pm| "Jules drops the keys in the ashtray.\n#{pm}. Settled in for the long quiet." }
    ].freeze
